...
import { collection, CollectionReference, doc, addDoc, getDocs } from "firebase/firestore";
...
const Account = () => {
  ...
  useEffect(() => {
    ...
    const createShortLink = async (name, longURL) => {
      ...
      await addDoc(collectionReference, { name: newName, longURL: links })
      // const res = await db
      //   .collection('users')
      ...
      // addDoc(collectionReference, links)
      console.log(links)
